var MistyBars = function(o) {
	...
	var draw = function() {
		...
		j(id + ' .content').append('\
			<img class="status grayscale" src="images/bedlam-status.png">\
			<img class="bars" src="images/bedlam-status-bars.png">\
			<div class="smoke hpbar"><img src="images/bedlam-orb-smoke.png"></div>\
