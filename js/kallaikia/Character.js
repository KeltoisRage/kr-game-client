Kallaikia.Character = function (game) {
	Kallaikia.AnimatedEntity.call(this,
		game,
...
Kallaikia.Character.prototype = Object.create(Kallaikia.AnimatedEntity.prototype);
/*
...
*/
Kallaikia.Character.prototype.update = function (delta) {
	if (this.walkTo) {
...
Kallaikia.Character.prototype.walk = function (target) {
	this.walkTo = target;
}
