var JujuMapper = function(o) {
	...
	o.loadURL = o.loadURL || 'index.html?option=com_portal&task=get_map&host='+Config.host+'&port='+Config.port;
	o.saveURL = 'index.html?option=com_portal&task=save_map&host='+Config.host+'&port='+Config.port;
