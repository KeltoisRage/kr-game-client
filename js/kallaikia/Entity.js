Kallaikia.Entity = function (game, modelPath, texturePath, scale) {
	Kallaikia.Component.call(this, game);
...
Kallaikia.Entity.prototype = Object.create(Kallaikia.Component.prototype);

Kallaikia.Entity.prototype.loadContent = function (callback) {
	var mapping = new THREE.UVMapping();
	var that = this;
	var texture = THREE.TextureLoader(this.texturePath, mapping, function () {
