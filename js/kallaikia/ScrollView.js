var ScrollView = function(o) {
	...
	if (mobile) {
		...
		j(id + ' .input').append('<a class="kbutton multiline tip" title="Send multi-line text." style="height: 16px !important; padding: 4px 8px !important; margin-left: 6px; position: relative;"><i class="icon-align-justify"></i></a>');
